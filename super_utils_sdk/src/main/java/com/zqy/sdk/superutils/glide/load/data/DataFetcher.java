package com.zqy.sdk.superutils.glide.load.data;
 ...
 * resource load by {@linkcom.zqy.sutils.glide.load.model.ModelLoader}. {@link #loadData(Priority)} may or may not be
...
public interface DataFetcher<T> {
     ...
     * {@linkcom.zqy.sutils.glide.load.ResourceDecoder}.
     *
     * <p>
     *     Note - this method will be run on a background thread so blocking I/O is safe.
     * </p>
