...
public class LanguageUtils {
    ...
    private static void applyLanguage(@NonNull final Locale locale,
                                      ...
                                      final boolean isNeedStartActivity) {
        if (isFollowSystem) {
            com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getSpUtils4Utils().put(KEY_LOCALE, VALUE_FOLLOW_SYSTEM);
        } else {
            com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getSpUtils4Utils().put(KEY_LOCALE, locale2String(locale));
        }

        updateLanguage(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), locale);

        if (isNeedStartActivity) {
            Intent intent = new Intent();
            String realActivityClassName = TextUtils.isEmpty(activityClassName) ? com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getLauncherActivity() : activityClassName;
            intent.setComponent(new ComponentName(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), realActivityClassName));
    ...
    public static boolean isAppliedSystemLanguage() {
        return VALUE_FOLLOW_SYSTEM.equals(com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getSpUtils4Utils().getString(KEY_LOCALE));
    }
    ...
    public static boolean isAppliedLanguage() {
        return !TextUtils.isEmpty(com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getSpUtils4Utils().getString(KEY_LOCALE));
    }
    ...
    public static boolean isAppliedLanguage(Locale locale) {
        final String spLocale = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getSpUtils4Utils().getString(KEY_LOCALE);
    ...
    public static Locale getCurrentLocale() {
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getResources().getConfiguration().locale;
    }

    static void applyLanguage(@NonNull final Activity activity) {
        String spLocale = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getSpUtils4Utils().getString(KEY_LOCALE);
        if (TextUtils.isEmpty(spLocale)) {
            return;
        }
        ...
        if (VALUE_FOLLOW_SYSTEM.equals(spLocale)) {
            ...
            updateLanguage(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), sysLocale);
    ...
    private static boolean isSameLocale(Locale l0, Locale l1) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.equals(l1.getLanguage(), l0.getLanguage())
                && com.zqy.sdk.superutils.utilcode.util.UtilsBridge.equals(l1.getCountry(), l0.getCountry());
    }
}
