...
public final class DeviceUtils {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp()
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
