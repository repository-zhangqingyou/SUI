...
/**
 * A {@linkcom.zqy.sutils.glide.provider.LoadProvider} that returns classes preferentially from those set on it but
 * that also defaults to a wrapped {@linkcom.zqy.sutils.glide.provider.LoadProvider} when a particular class is not set.
 *
...
public class ChildLoadProvider<A, T, Z, R> implements LoadProvider<A, T, Z, R>, Cloneable {
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.ResourceDecoder} to use for decoding the resource from the disk cache.
     *
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.ResourceDecoder} to use to decoding the resource from the original data.
     *
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.ResourceEncoder} to use to write the decoded and transformed resource to
     * the disk cache.
     *
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder} to use to transcode the decoded
     * resource.
     *
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.Encoder} to use to write the original data to the disk cache.
     *
