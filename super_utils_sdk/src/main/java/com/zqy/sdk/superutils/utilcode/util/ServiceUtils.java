...
public final class ServiceUtils {
    ...
    public static void startService(@NonNull final Class<?> cls) {
        Intent intent = new Intent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), cls);
    ...
    public static boolean stopService(@NonNull final Class<?> cls) {
        Intent intent = new Intent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), cls);
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().stopService(intent);
    }
    ...
    public static void bindService(@NonNull final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), cls);
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(@NonNull final ServiceConnection conn) {
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().unbindService(conn);
    }
