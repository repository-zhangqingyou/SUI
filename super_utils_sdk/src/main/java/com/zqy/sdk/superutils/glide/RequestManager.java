package com.zqy.sdk.superutils.glide;
...
import com.zqy.sdk.superutils.glide.load.engine.DiskCacheStrategy;
import com.zqy.sdk.superutils.glide.load.model.ModelLoader;
import com.zqy.sdk.superutils.glide.load.model.file_descriptor.FileDescriptorModelLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.MediaStoreStreamLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamByteArrayLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamModelLoader;
import com.zqy.sdk.superutils.glide.manager.ConnectivityMonitor;
import com.zqy.sdk.superutils.glide.manager.ConnectivityMonitorFactory;
import com.zqy.sdk.superutils.glide.manager.Lifecycle;
import com.zqy.sdk.superutils.glide.manager.LifecycleListener;
import com.zqy.sdk.superutils.glide.manager.RequestManagerTreeNode;
import com.zqy.sdk.superutils.glide.manager.RequestTracker;
import com.zqy.sdk.superutils.glide.signature.ApplicationVersionSignature;
import com.zqy.sdk.superutils.glide.signature.MediaStoreSignature;
import com.zqy.sdk.superutils.glide.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
     ...
     * {@linkcom.zqy.sutils.glide.RequestManager}.
     */
     ...
     *
     * <p>
     *     Note - These options will be retained for the life the of this {@linkcom.zqy.sutils.glide.RequestManager}
     *     so be wary of using
     *     {@linkcom.zqy.sutils.glide.GenericRequestBuilder#listener(com.bumptech.glide.request.RequestListener)}} when
    ...
    /**
     * Returns a request builder that uses the given {@linkcom.zqy.sutils.glide.load.model.ModelLoader} to fetch a
     * generic data type.
     *
     * <p>
    ...
    /**
     * Returns a request builder that uses the given {@linkcom.zqy.sutils.glide.load.model.stream.StreamModelLoader} to
     ...
     * {@linkcom.zqy.sutils.glide.load.model.stream.StreamByteArrayLoader} to fetch an {@link java.io.InputStream} for
     * loading Bitmaps.
     *
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@linkcom.zqy.sutils.glide.load.model.UriLoader}.
     */
     ...
     *     {@linkcom.zqy.sutils.glide.GenericRequestBuilder#signature(com.bumptech.glide.load.Key)} to mixin a signature
     *     you create that identifies the data currently at the given String that will invalidate the cache if that data
     *     changes. Alternatively, using {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@linkcom.zqy.sutils.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     * @see #load(String)
     ...
     * {@linkcom.zqy.sutils.glide.load.model.UriLoader}.
     */
     ...
     *     Alternatively, using {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@linkcom.zqy.sutils.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     ...
     * @seecom.zqy.sutils.glide.GenericRequestBuilder#signature(com.bumptech.glide.load.Key)
     */
     ...
     * @seecom.zqy.sutils.glide.GenericRequestBuilder#signature(com.bumptech.glide.load.Key)
     * @seecom.zqy.sutils.glide.signature.MediaStoreSignature
     *
     * @deprecated Use {@link #loadFromMediaStore(android.net.Uri)},
     * {@linkcom.zqy.sutils.glide.signature.MediaStoreSignature}, and
     * {@linkcom.zqy.sutils.glide.DrawableRequestBuilder#signature(com.bumptech.glide.load.Key)} instead. Scheduled to be
     ...
     *
     * <p>
     *  Falls back to the registered {@linkcom.zqy.sutils.glide.load.model.ModelLoaderFactory} registered for
     ...
     *     {@linkcom.zqy.sutils.glide.GenericRequestBuilder#signature(com.bumptech.glide.load.Key)} to mix in some
     *     additional data identifying the current state of the Uri, preferably using
     *     {@linkcom.zqy.sutils.glide.signature.MediaStoreSignature}. Alternatively consider avoiding the memory and
     *     disk caches entirely using
     *     {@link GenericRequestBuilder#diskCacheStrategy(com.bumptech.glide.load.engine.DiskCacheStrategy)}
     *     and {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@linkcom.zqy.sutils.glide.GenericRequestBuilder#skipMemoryCache(boolean)}.
     * </p>
     *
     * @see #from(Class)
     * @see #loadFromMediaStore(android.net.Uri, String, long, int)
    ...
    /**
     * Returns a request builder that uses the {@linkcom.zqy.sutils.glide.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@linkcom.zqy.sutils.glide.load.model.stream.StreamFileLoader.Factory} and
     * {@linkcom.zqy.sutils.glide.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@linkcom.zqy.sutils.glide.load.model.stream.StreamResourceLoader.Factory} and
     * {@linkcom.zqy.sutils.glide.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     *     cached data. To get around this, consider using {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#NONE}
     ...
     *     {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#RESULT} for release builds.
     * </p>
     *
     * @see #from(Class)
     * @see #load(Integer)
     * @seecom.zqy.sutils.glide.signature.ApplicationVersionSignature
     * @seecom.zqy.sutils.glide.GenericRequestBuilder#signature(com.bumptech.glide.load.Key)
     */
     ...
     * {@linkcom.zqy.sutils.glide.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@linkcom.zqy.sutils.glide.load.data.HttpUrlFetcher} to load {@link java.net.URL} models.
     *
     * @see #from(Class)
     ...
     * {@linkcom.zqy.sutils.glide.GenericRequestBuilder#signature(com.bumptech.glide.load.Key)} instead. Scheduled to be
     * removed in Glide 4.0.
    ...
    /**
     * Returns a request builder that uses {@linkcom.zqy.sutils.glide.load.model.stream.StreamByteArrayLoader} to load
    ...
    /**
     * Returns a request builder that uses the {@linkcom.zqy.sutils.glide.load.model.ModelLoaderFactory}s currently
     ...
     * {@linkcom.zqy.sutils.glide.load.model.ModelLoaderFactory}s registered for the given model class for
     ...
     *
     * <p>
     *     Note - you must use {@linkcom.zqy.sutils.glide.DrawableRequestBuilder#load(Object)}} to set a concrete model
     *     to be loaded before calling
     *     {@linkcom.zqy.sutils.glide.DrawableRequestBuilder#into(com.bumptech.glide.request.target.Target)}. You may
     *     also use this object for repeated loads by calling <code>request.load(model).into(target)</code>. You may
     *     also adjust the options after calling {@linkcom.zqy.sutils.glide.DrawableRequestBuilder#load(Object)}} and/or
     *     {@linkcom.zqy.sutils.glide.DrawableRequestBuilder#into(com.bumptech.glide.request.target.Target)}}. However,
    ...
    public final class ImageModelRequest<T> {
        ...
        /**
         * Returns a request builder that uses the provided {@linkcom.zqy.sutils.glide.load.model.ModelLoader} to load
     ...
     * @param <T> The type of data the {@linkcom.zqy.sutils.glide.load.model.ModelLoader} provides an
     * {@linkcom.zqy.sutils.glide.load.data.DataFetcher} to convert the model to.
     */
    public final class GenericModelRequest<A, T> {
        ...
        /**
         * A helper class for building requests with custom {@linkcom.zqy.sutils.glide.load.model.ModelLoader}s that
