...
public final class AppUtils {
     ...
     */
    public static void registerAppStatusChangedListener(@NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.OnAppStatusChangedListener listener) {
     ...
     * @param listener The status of application changed listener
     */
    public static void unregisterAppStatusChangedListener(@NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.OnAppStatusChangedListener listener) {
    ...
    public static void installApp(final File file) {
        ...
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(installAppIntent);
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(UtilsBridge.getUninstallAppIntent(packageName));
    }
    ...
    public static boolean isAppInstalled(final String pkgName) {
        ...
        PackageManager pm = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        ...
        ApplicationInfo ai = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getApplicationInfo();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager am = (ActivityManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) return false;
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                if (aInfo.processName.equals(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName())) {
                    return true;
                }
            }
        }
    ...
    public static void launchApp(final String packageName) {
        ...
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(launchAppIntent);
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        Intent intent = UtilsBridge.getLaunchAppIntent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
        if (intent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
        ...
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final Activity activity, final int requestCode) {
        launchAppDetailsSettings(activity, requestCode, com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static int getAppIconId() {
        return getAppIconId(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static int getAppUid() {
        return getAppUid(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static int getAppUid(String pkgName) {
        try {
            return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageManager().getApplicationInfo(pkgName, 0).uid;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
