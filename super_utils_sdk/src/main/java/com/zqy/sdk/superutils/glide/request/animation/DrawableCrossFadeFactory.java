...
/**
 * A factory class that produces a new {@linkcom.zqy.sutils.glide.request.animation.GlideAnimation} that varies depending
 ...
 *     cache this factory produces an {@linkcom.zqy.sutils.glide.request.animation.NoAnimation}.
 * </p>
 *
