package com.zqy.sdk.superutils.glide.load.resource.gifbitmap;
...
/**
 * A {@linkcom.zqy.sutils.glide.load.Transformation} that can apply a wrapped {@link android.graphics.Bitmap}
 * transformation to both {@link android.graphics.Bitmap}s and {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable}.
 */
