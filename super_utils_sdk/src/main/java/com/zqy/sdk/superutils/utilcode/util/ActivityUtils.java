...
public final class ActivityUtils {
    ...
    public static void addActivityLifecycleCallbacks(final Activity activity,
        ...
        com.zqy.sdk.superutils.utilcode.util.UtilsBridge.addActivityLifecycleCallbacks(activity, callbacks);
    }
    ...
    public static void removeActivityLifecycleCallbacks(final Activity activity) {
        com.zqy.sdk.superutils.utilcode.util.UtilsBridge.removeActivityLifecycleCallbacks(activity);
    }
    ...
    public static void removeActivityLifecycleCallbacks(final Activity activity,
                                                        final com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks callbacks) {
        com.zqy.sdk.superutils.utilcode.util.UtilsBridge.removeActivityLifecycleCallbacks(activity, callbacks);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @Nullable final Bundle options) {
        return startActivity(intent, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivityForResult(@NonNull final Fragment fragment,
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, null, com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivityForResult(@NonNull final Bundle extras,
                                              ...
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, extras, com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       @Nullable final Bundle options) {
        startActivities(intents, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivityOrApp(), options);
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static List<Activity> getActivityList() {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isSpace(pkg)) return "";
    ...
    public static List<String> getMainActivities() {
        return getMainActivities(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), clz));
    }
