...
public final class MetaDataUtils {
    ...
    public static String getMetaDataInApp(@NonNull final String key) {
        ...
        String packageName = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName();
        try {
    ...
    public static String getMetaDataInActivity(@NonNull final Class<? extends Activity> clz,
        ...
        String value = "";
        PackageManager pm = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageManager();
        ComponentName componentName = new ComponentName(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), clz);
        try {
