...
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp()
    ...
    public static boolean isMainProcess() {
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName().equals(getCurrentProcessName());
    }
