...
public final class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getContentResolver(),
