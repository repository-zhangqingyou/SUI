...
/**
 * A view-less {@link android.app.Fragment} used to safely store an {@linkcom.zqy.sutils.glide.RequestManager} that
 * can be used to start, stop and manage Glide requests started for targets the fragment or activity this fragment is a
 * child of.
 *
 * @seecom.zqy.sutils.glide.manager.SupportRequestManagerFragment
...
public class RequestManagerFragment extends Fragment {
    ...
    /**
     * Returns the current {@linkcom.zqy.sutils.glide.RequestManager} or null if none exists.
     */
