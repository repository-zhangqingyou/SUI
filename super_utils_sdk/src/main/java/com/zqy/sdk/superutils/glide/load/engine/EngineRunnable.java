...
import com.zqy.sdk.superutils.glide.load.engine.executor.Prioritized;
import com.zqy.sdk.superutils.glide.request.ResourceCallback;

/**
 * A runnable class responsible for using an {@linkcom.zqy.sutils.glide.load.engine.DecodeJob} to decode resources on a
 ...
 *     {@linkcom.zqy.sutils.glide.load.engine.DecodeJob} to decode data directly from the original source.
 * </p>
 *
 * <p>
