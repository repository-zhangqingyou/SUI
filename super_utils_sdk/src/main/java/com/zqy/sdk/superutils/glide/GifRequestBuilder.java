...
import com.zqy.sdk.superutils.glide.load.resource.gif.GifDrawableTransformation;
...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@linkcom.zqy.sutils.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transforms each frame of the GIF using {@linkcom.zqy.sutils.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(com.bumptech.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(com.bumptech.glide.load.Transformation[])
