...
/**
 * A simple {@linkcom.zqy.sutils.glide.request.animation.GlideAnimation} that performs no actions.
 *
...
public class NoAnimation<R> implements GlideAnimation<R> {
    ...
    /**
     * A factory that always returns the same {@linkcom.zqy.sutils.glide.request.animation.NoAnimation}.
     */
    ...
    /**
     * Returns an instance of a factory that produces {@linkcom.zqy.sutils.glide.request.animation.NoAnimation}s.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns an instance of {@linkcom.zqy.sutils.glide.request.animation.NoAnimation}.
     */
    @SuppressWarnings("unchecked")
