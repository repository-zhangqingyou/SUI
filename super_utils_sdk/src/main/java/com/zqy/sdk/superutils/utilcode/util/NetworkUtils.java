...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(
    ...
    public static com.zqy.sdk.superutils.utilcode.util.Utils.Task<Boolean> isAvailableAsync(@NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Boolean> consumer) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.doAsync(new com.zqy.sdk.superutils.utilcode.util.Utils.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByPingAsync(final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static com.zqy.sdk.superutils.utilcode.util.Utils.Task<Boolean> isAvailableByPingAsync(final String ip,
                                                                                                  @NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Boolean> consumer) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.doAsync(new com.zqy.sdk.superutils.utilcode.util.Utils.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
            public Boolean doInBackground() {
    ...
    public static boolean isAvailableByPing(final String ip) {
        ...
        com.zqy.sdk.superutils.utilcode.util.ShellUtils.CommandResult result = ShellUtils.execCmd(String.format("ping -c 1 %s", realIp), false);
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByDnsAsync(final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static com.zqy.sdk.superutils.utilcode.util.Utils.Task isAvailableByDnsAsync(final String domain,
                                                                                        @NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Boolean> consumer) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.doAsync(new com.zqy.sdk.superutils.utilcode.util.Utils.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
     ...
     */
    @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
    public static com.zqy.sdk.superutils.utilcode.util.Utils.Task<Boolean> isWifiAvailableAsync(@NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Boolean> consumer) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.doAsync(new com.zqy.sdk.superutils.utilcode.util.Utils.Task<Boolean>(consumer) {
            @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
            @Override
            public Boolean doInBackground() {
     ...
     * @return the task
     */
    public static com.zqy.sdk.superutils.utilcode.util.Utils.Task<String> getIPAddressAsync(final boolean useIPv4,
                                                                                            @NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<String> consumer) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.doAsync(new com.zqy.sdk.superutils.utilcode.util.Utils.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static com.zqy.sdk.superutils.utilcode.util.Utils.Task<String> getDomainAddressAsync(final String domain,
                                                                                                @NonNull final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<String> consumer) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.doAsync(new com.zqy.sdk.superutils.utilcode.util.Utils.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static String getSSID() {
        WifiManager wm = (WifiManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getApplicationContext().getSystemService(WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static final class NetworkChangedReceiver extends BroadcastReceiver {
        ...
        void registerListener(final OnNetworkStatusChangedListener listener) {
            ...
            com.zqy.sdk.superutils.utilcode.util.UtilsBridge.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
        }
        ...
        public void onReceive(Context context, Intent intent) {
            if (ConnectivityManager.CONNECTIVITY_ACTION.equals(intent.getAction())) {
                // debouncing
                com.zqy.sdk.superutils.utilcode.util.UtilsBridge.runOnUiThreadDelayed(new Runnable() {
                    @Override
                    public void run() {
