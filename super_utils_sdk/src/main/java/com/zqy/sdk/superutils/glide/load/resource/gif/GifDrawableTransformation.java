...
/**
 * An {@linkcom.zqy.sutils.glide.load.Transformation} that wraps a transformation for a {@link Bitmap}
 * and can apply it to every frame of any {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable}.
 */
