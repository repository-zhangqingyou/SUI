...
import com.zqy.sdk.superutils.utilcode.constant.MemoryConstants;
import com.zqy.sdk.superutils.utilcode.constant.TimeConstants;
...
public final class ConvertUtils {
    ...
    public static byte[] hexString2Bytes(String hexString) {
        if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isSpace(hexString)) return new byte[0];
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bitmap2Bytes(bitmap);
    }
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap, final Bitmap.CompressFormat format, int quality) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bitmap2Bytes(bitmap, format, quality);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.drawable2Bytes(drawable);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable, final Bitmap.CompressFormat format, int quality) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.drawable2Bytes(drawable, format, quality);
    }
    ...
    public static String millis2FitTimeSpan(long millis, int precision) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.millis2FitTimeSpan(millis, precision);
    }
    ...
    public static Bitmap drawable2Bitmap(final Drawable drawable) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.drawable2Bitmap(drawable);
    }
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bitmap2Drawable(bitmap);
    }
    ...
    public static Bitmap view2Bitmap(final View view) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.view2Bitmap(view);
    }
    ...
    public static int dp2px(final float dpValue) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.dp2px(dpValue);
    }
    ...
    public static int px2dp(final float pxValue) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.px2dp(pxValue);
    }
    ...
    public static int sp2px(final float spValue) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.sp2px(spValue);
    }
    ...
    public static int px2sp(final float pxValue) {
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.px2sp(pxValue);
    }

    private static String getSafeCharset(String charsetName) {
        String cn = charsetName;
        if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isSpace(charsetName) || !Charset.isSupported(charsetName)) {
            cn = "UTF-8";
        }
        return cn;
    }
