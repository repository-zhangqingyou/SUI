...
import com.zqy.sdk.superutils.glide.load.engine.Engine;
import com.zqy.sdk.superutils.glide.load.engine.bitmap_recycle.BitmapPool;
import com.zqy.sdk.superutils.glide.load.engine.cache.DiskLruCacheFactory;
import com.zqy.sdk.superutils.glide.load.engine.cache.MemoryCache;
import com.zqy.sdk.superutils.glide.load.engine.prefill.BitmapPreFiller;
import com.zqy.sdk.superutils.glide.load.engine.prefill.PreFillType;
import com.zqy.sdk.superutils.glide.load.model.GenericLoaderFactory;
import com.zqy.sdk.superutils.glide.load.model.GlideUrl;
...
import com.zqy.sdk.superutils.glide.load.model.ModelLoaderFactory;
import com.zqy.sdk.superutils.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import com.zqy.sdk.superutils.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.zqy.sdk.superutils.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import com.zqy.sdk.superutils.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.HttpUrlGlideUrlLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamByteArrayLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamFileLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamResourceLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamStringLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamUriLoader;
import com.zqy.sdk.superutils.glide.load.model.stream.StreamUrlLoader;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.CenterCrop;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.FitCenter;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.GlideBitmapDrawable;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.zqy.sdk.superutils.glide.load.resource.drawable.GlideDrawable;
import com.zqy.sdk.superutils.glide.load.resource.file.StreamFileDataLoadProvider;
import com.zqy.sdk.superutils.glide.load.resource.gif.GifDrawable;
import com.zqy.sdk.superutils.glide.load.resource.gif.GifDrawableLoadProvider;
import com.zqy.sdk.superutils.glide.load.resource.gifbitmap.GifBitmapWrapper;
import com.zqy.sdk.superutils.glide.load.resource.gifbitmap.GifBitmapWrapperTransformation;
import com.zqy.sdk.superutils.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.zqy.sdk.superutils.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import com.zqy.sdk.superutils.glide.load.resource.transcode.GlideBitmapDrawableTranscoder;
import com.zqy.sdk.superutils.glide.load.resource.transcode.ResourceTranscoder;
import com.zqy.sdk.superutils.glide.load.resource.transcode.TranscoderRegistry;
import com.zqy.sdk.superutils.glide.manager.RequestManagerRetriever;
import com.zqy.sdk.superutils.glide.module.GlideModule;
import com.zqy.sdk.superutils.glide.module.ManifestParser;
import com.zqy.sdk.superutils.glide.provider.DataLoadProvider;
import com.zqy.sdk.superutils.glide.provider.DataLoadProviderRegistry;
import com.zqy.sdk.superutils.glide.request.FutureTarget;
import com.zqy.sdk.superutils.glide.request.Request;
import com.zqy.sdk.superutils.glide.request.animation.GlideAnimation;
import com.zqy.sdk.superutils.glide.request.target.ImageViewTargetFactory;
import com.zqy.sdk.superutils.glide.request.target.Target;
import com.zqy.sdk.superutils.glide.request.target.ViewTarget;
 ...
 * maintaining an {@link Engine}, {@link BitmapPool}, {@linkcom.zqy.sutils.glide.load.engine.cache.DiskCache} and
 * {@link MemoryCache}.
 */
public class Glide {
     ...
     *
     * @deprecated Use {@linkcom.zqy.sutils.glide.module.GlideModule} instead. Scheduled to be removed in Glide 4.0.
     */
    @Deprecated
    ...
    /**
     * Returns the {@linkcom.zqy.sutils.glide.load.engine.bitmap_recycle.BitmapPool} used to temporarily store
     ...
     *     {@linkcom.zqy.sutils.glide.load.ResourceDecoder}s and {@linkcom.zqy.sutils.glide.load.Transformation}s. Use
    ...
    /**
     * Pre-fills the {@linkcom.zqy.sutils.glide.load.engine.bitmap_recycle.BitmapPool} using the given sizes.
     *
     * <p>
     ...
     *     re-filling the {@linkcom.zqy.sutils.glide.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
     ...
     *     {@linkcom.zqy.sutils.glide.load.engine.prefill.PreFillType.Builder Builders} representing
     ...
     *
     * @deprecated Use {@link #register(Class, Class, com.zqy.sdk.superutils.glide.load.model.ModelLoaderFactory)} to replace
