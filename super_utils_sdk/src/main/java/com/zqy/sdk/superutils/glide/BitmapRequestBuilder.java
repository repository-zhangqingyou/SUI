...
import com.zqy.sdk.superutils.glide.load.resource.bitmap.BitmapTransformation;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.Downsampler;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.zqy.sdk.superutils.glide.load.resource.bitmap.VideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
     ...
     * {@linkcom.zqy.sutils.glide.load.resource.bitmap.Downsampler#AT_MOST}.
     *
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.ResourceDecoder} that will be used to decode {@link Bitmap}s obtained
    ...
    /**
     * Transform images using the given {@linkcom.zqy.sutils.glide.load.resource.bitmap.BitmapTransformation}s.
     *
     * @see #centerCrop()
     * @see #fitCenter()
    ...
    /**
     * Transform images using {@linkcom.zqy.sutils.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transform images using {@linkcom.zqy.sutils.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(com.bumptech.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(com.bumptech.glide.load.Transformation[])
