...
import com.zqy.sdk.superutils.glide.request.target.BaseTarget;
import com.zqy.sdk.superutils.glide.request.target.SizeReadyCallback;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public interface PreloadModelProvider<U> {
        ...
        /**
         * Returns a non null {@linkcom.zqy.sutils.glide.GenericRequestBuilder} for a given item. Must exactly match
    ...
    /**
     * Constructor for {@linkcom.zqy.sutils.glide.ListPreloader} that requires users to subclass and override
     ...
     * com.zqy.sdk.superutils.glide.ListPreloader.PreloadSizeProvider, int)} instead. This constructor will be removed in Glide
     * 4.0.
    ...
    /**
     * Constructor for {@linkcom.zqy.sutils.glide.ListPreloader} that accepts interfaces for providing the dimensions of
     ...
     * </p>
     *
     * @deprecated Use {@linkcom.zqy.sutils.glide.ListPreloader.PreloadSizeProvider} instead. This method will be removed
     * in Glide 4.0.
     * @param item A model
     ...
     * </p>
     *
     * @deprecated Use {@linkcom.zqy.sutils.glide.ListPreloader.PreloadModelProvider} instead. This method will be
    ...
    /**
     * Returns a non null {@linkcom.zqy.sutils.glide.GenericRequestBuilder} for a given item. Must exactly match the
