package com.zqy.sdk.superutils.glide.load;

/**
 * Options for setting the value of {@link android.graphics.Bitmap#getConfig()} for {@link android.graphics.Bitmap}s
 * returned by a {@linkcom.zqy.sutils.glide.load.resource.bitmap.BitmapDecoder}.
 *
 * <p>
 *     Note - In some cases it may not be possible to obey the requested setting, not all
 *     {@linkcom.zqy.sutils.glide.load.resource.bitmap.BitmapDecoder}s support setting formats and certain images may
...
public enum DecodeFormat {
    /**
     * All bitmaps returned by the {@linkcom.zqy.sutils.glide.load.resource.bitmap.BitmapDecoder} should return
