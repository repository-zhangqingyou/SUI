...
import com.zqy.sdk.superutils.utilcode.constant.CacheConstants;
...
public final class CacheDiskUtils implements CacheConstants {
    ...
    public static CacheDiskUtils getInstance(String cacheName, final long maxSize, final int maxCount) {
        if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isSpace(cacheName)) cacheName = "cacheUtils";
    ...
    private void realPutBytes(final String key, byte[] value, int saveTime) {
        ...
        com.zqy.sdk.superutils.utilcode.util.UtilsBridge.writeFileFromBytes(file, value);
    ...
    private byte[] realGetBytes(@NonNull final String key, final byte[] defaultValue) {
        ...
        byte[] data = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.readFile2Bytes(file);
    ...
    public void put(@NonNull final String key, final String value, final int saveTime) {
        realPutBytes(TYPE_STRING + key, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.string2Bytes(value), saveTime);
    }
    ...
    public String getString(@NonNull final String key, final String defaultValue) {
        ...
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bytes2String(bytes);
    }
    ...
    public void put(@NonNull final String key,
                    ...
                    final int saveTime) {
        realPutBytes(TYPE_JSON_OBJECT + key, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.jsonObject2Bytes(value), saveTime);
    }
    ...
    public JSONObject getJSONObject(@NonNull final String key, final JSONObject defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bytes2JSONObject(bytes);
    }
    ...
    public void put(@NonNull final String key, final JSONArray value, final int saveTime) {
        realPutBytes(TYPE_JSON_ARRAY + key, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.jsonArray2Bytes(value), saveTime);
    }
    ...
    public JSONArray getJSONArray(@NonNull final String key, final JSONArray defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bytes2JSONArray(bytes);
    }
    ...
    public void put(@NonNull final String key, final Bitmap value, final int saveTime) {
        realPutBytes(TYPE_BITMAP + key, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bitmap2Bytes(value), saveTime);
    }
    ...
    public Bitmap getBitmap(@NonNull final String key, final Bitmap defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bytes2Bitmap(bytes);
    }
    ...
    public void put(@NonNull final String key, final Drawable value, final int saveTime) {
        realPutBytes(TYPE_DRAWABLE + key, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.drawable2Bytes(value), saveTime);
    }
    ...
    public Drawable getDrawable(@NonNull final String key, final Drawable defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bytes2Drawable(bytes);
    }
    ...
    public void put(@NonNull final String key, final Parcelable value, final int saveTime) {
        realPutBytes(TYPE_PARCELABLE + key, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.parcelable2Bytes(value), saveTime);
    }
    ...
    public <T> T getParcelable(@NonNull final String key,
        ...
        if (bytes == null) return defaultValue;
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bytes2Parcelable(bytes, creator);
    }
    ...
    public void put(@NonNull final String key, final Serializable value, final int saveTime) {
        realPutBytes(TYPE_SERIALIZABLE + key, com.zqy.sdk.superutils.utilcode.util.UtilsBridge.serializable2Bytes(value), saveTime);
    }
    ...
    public Object getSerializable(@NonNull final String key, final Object defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return com.zqy.sdk.superutils.utilcode.util.UtilsBridge.bytes2Object(bytes);
    }
