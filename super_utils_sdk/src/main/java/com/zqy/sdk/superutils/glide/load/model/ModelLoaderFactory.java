 ...
 * {@link Context}.
 *
 * @param <T> The type of the model the {@linkcom.zqy.sutils.glide.load.model.ModelLoader}s built by this factory
 *           can handle
 * @param <Y> The type of data the {@linkcom.zqy.sutils.glide.load.model.ModelLoader}s built by this factory can load.
 */
