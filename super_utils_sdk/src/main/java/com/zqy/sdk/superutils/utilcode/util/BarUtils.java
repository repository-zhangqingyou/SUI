...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
    ...
    private static String getResNameById(int id) {
        try {
            return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getResources().getResourceEntryName(id);
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.WINDOW_SERVICE);
