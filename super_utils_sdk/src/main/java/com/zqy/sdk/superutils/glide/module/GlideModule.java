package com.zqy.sdk.superutils.glide.module;

import android.content.Context;

import com.zqy.sdk.superutils.glide.Glide;
import com.zqy.sdk.superutils.glide.GlideBuilder;

/**
 * An interface allowing lazy configuration of Glide including setting options using
 * {@linkcom.zqy.sutils.glide.GlideBuilder} and registering
 * {@linkcom.zqy.sutils.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p>
 ...
 *             {@linkcom.zqy.sutils.glide.Glide#register(Class, Class,com.zqy.sutils.glide.load.model.ModelLoaderFactory)}
 *             for each {@linkcom.zqy.sutils.glide.load.model.ModelLoader} you'd like to register:
 *             <pre>
 *                  <code>
 ...
 *              <pre>
 *                  {@code
 *                      -keepnames class *com.zqy.sutils.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 *         </li>
 *         <li>
...
public interface GlideModule {
    ...
    /**
     * Lazily apply options to a {@linkcom.zqy.sutils.glide.GlideBuilder} immediately before the Glide singleton is
     * created.
     *
     * <p>
     ...
     * @param builder The {@linkcom.zqy.sutils.glide.GlideBuilder} that will be used to create Glide.
     */
