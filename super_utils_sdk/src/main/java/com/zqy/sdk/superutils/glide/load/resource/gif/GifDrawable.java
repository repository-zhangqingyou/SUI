...
import com.zqy.sdk.superutils.glide.gifdecoder.GifDecoder;
import com.zqy.sdk.superutils.glide.gifdecoder.GifHeader;
...
public class GifDrawable extends GlideDrawable implements GifFrameLoader.FrameCallback {
     ...
     * @param bitmapProvider An {@linkcom.zqy.sutils.glide.gifdecoder.GifDecoder.BitmapProvider} that can be used to
     *                       retrieve re-usable {@link android.graphics.Bitmap}s.
     * @param bitmapPool A {@linkcom.zqy.sutils.glide.load.engine.bitmap_recycle.BitmapPool} that can be used to return
     *                   the first frame when this drawable is recycled.
     * @param frameTransformation An {@linkcom.zqy.sutils.glide.load.Transformation} that can be applied to each frame.
     * @param targetFrameWidth The desired width of the frames displayed by this drawable (the width of the view or
     *                         {@linkcom.zqy.sutils.glide.request.target.Target} this drawable is being loaded into).
