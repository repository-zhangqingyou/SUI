package com.zqy.sdk.superutils.glide.load.resource.transcode;

import com.zqy.sdk.superutils.glide.util.MultiClassKey;

import java.util.HashMap;
import java.util.Map;

/**
 * A class that allows {@linkcom.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder}s to be registered and
...
public class TranscoderRegistry {
    ...
    /**
     * Registers the given {@linkcom.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder} using the given
    ...
    /**
     * Returns the currently registered {@linkcom.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder} for the
     * given classes.
     *
     * @param decodedClass The class of the resource that the transcoder transcodes from.
     * @param transcodedClass The class of the resource that the transcoder transcodes to.
