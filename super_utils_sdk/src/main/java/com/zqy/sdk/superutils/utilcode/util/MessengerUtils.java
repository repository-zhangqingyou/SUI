...
public class MessengerUtils {
    ...
    public static void register() {
        if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isMainProcess()) {
            if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isServiceRunning(ServerService.class.getName())) {
                Log.i("MessengerUtils", "Server service is running.");
                return;
            }
            Intent intent = new Intent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), ServerService.class);
            com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startService(intent);
            return;
        }
    ...
    public static void unregister() {
        if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isMainProcess()) {
            ...
            Intent intent = new Intent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), ServerService.class);
            com.zqy.sdk.superutils.utilcode.util.Utils.getApp().stopService(intent);
        }
        if (sLocalClient != null) {
            sLocalClient.unbind();
        }
    ...
    static class Client {
        ...
        ServiceConnection mConn   = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                int key = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getCurrentProcessName().hashCode();
        ...
        boolean bind() {
            if (TextUtils.isEmpty(mPkgName)) {
                Intent intent = new Intent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), ServerService.class);
                return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().bindService(intent, mConn, Context.BIND_AUTO_CREATE);
            }
            if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isAppInstalled(mPkgName)) {
                if (com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isAppRunning(mPkgName)) {
