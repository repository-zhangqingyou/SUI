...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return UtilsBridge.deleteAllInDir(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return UtilsBridge.deleteAllInDir(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return UtilsBridge.deleteAllInDir(new File(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return UtilsBridge.deleteAllInDir(new File(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getFilesDir().getParent(), "shared_prefs"));
    }
