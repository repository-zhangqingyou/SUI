...
public final class PhoneUtils {
    ...
    public static void dial(final String phoneNumber) {
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(UtilsBridge.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(UtilsBridge.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        com.zqy.sdk.superutils.utilcode.util.Utils.getApp().startActivity(UtilsBridge.getSendSmsIntent(phoneNumber, content));
    }
