package com.zqy.sdk.superutils.glide.request.animation;
 ...
 * {@linkcom.zqy.sutils.glide.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * {@linkcom.zqy.sutils.glide.request.animation.ViewPropertyAnimation} and animated
     ...
     * @param adapter The {@linkcom.zqy.sutils.glide.request.animation.GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link android.view.View} from
     *                {@linkcom.zqy.sutils.glide.request.animation.GlideAnimation.ViewAdapter#getView()}.
