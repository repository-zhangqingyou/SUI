...
import com.zqy.sdk.superutils.glide.load.model.ImageVideoModelLoader;
 ...
 * adds an {@linkcom.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder} to transcode the data into a
...
public class DrawableTypeRequest<ModelType> extends DrawableRequestBuilder<ModelType> implements DownloadOptions {
    ...
    /**
     * Attempts to always load the resource as a {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable}.
     * <p>
     ...
     *     just an {@linkcom.zqy.sutils.glide.DrawableTypeRequest} is sufficient because it will determine whether or
     ...
     * </p>
     *
     * @return A new request builder for loading a {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable}.
     */
