...
public final class KeyboardUtils {
    ...
    public static void showSoftInput() {
        InputMethodManager imm = (InputMethodManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    public static void showSoftInput(@NonNull final View view, final int flags) {
        InputMethodManager imm =
                (InputMethodManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
    ...
    private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
        ...
        if (delta <= com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getNavBarHeight() + com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getStatusBarHeight()) {
    ...
    private static int getContentViewInvisibleHeight(final Window window) {
        ...
        if (delta <= com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getStatusBarHeight() + com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getNavBarHeight()) {
            return 0;
        }
        return delta;
    }
