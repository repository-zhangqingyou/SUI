...
import com.zqy.sdk.superutils.glide.load.data.ByteArrayFetcher;
...
public class StreamByteArrayLoader implements StreamModelLoader<byte[]> {
    ...
    /**
     * @deprecated Use {@linkcom.zqy.sutils.glide.GenericRequestBuilder#signature(com.bumptech.glide.load.Key)}
    ...
    /**
     * Factory for {@linkcom.zqy.sutils.glide.load.model.stream.StreamByteArrayLoader}.
     */
