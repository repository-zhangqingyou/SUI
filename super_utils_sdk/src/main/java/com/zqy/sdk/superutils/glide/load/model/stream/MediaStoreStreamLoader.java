...
import com.zqy.sdk.superutils.glide.load.data.MediaStoreThumbFetcher;
import com.zqy.sdk.superutils.glide.load.model.ModelLoader;

import java.io.InputStream;

/**
 * An {@linkcom.zqy.sutils.glide.load.model.ModelLoader} that can use media store uris to open pre-generated thumbnails
 ...
 * it falls back to the wrapped {@linkcom.zqy.sutils.glide.load.model.ModelLoader} to load the
