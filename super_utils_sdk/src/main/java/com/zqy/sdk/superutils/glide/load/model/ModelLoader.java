package com.zqy.sdk.superutils.glide.load.model;
 ...
 * @param <Y> The type of the data that can be used by a {@linkcom.zqy.sutils.glide.load.ResourceDecoder} to decode a
 *           resource.
 */
public interface ModelLoader<T, Y> {
     ...
     *              {@linkcom.zqy.sutils.glide.request.target.Target#SIZE_ORIGINAL} to indicate that the resource should
     ...
     * cached, or null if no valid {@linkcom.zqy.sutils.glide.load.data.DataFetcher} could be constructed.
     */
