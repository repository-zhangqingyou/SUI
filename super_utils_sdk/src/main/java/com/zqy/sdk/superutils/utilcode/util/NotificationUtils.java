...
public class NotificationUtils {
    ...
    public static boolean areNotificationsEnabled() {
        return NotificationManagerCompat.from(com.zqy.sdk.superutils.utilcode.util.Utils.getApp()).areNotificationsEnabled();
    }
     ...
     */
    public static void notify(int id, com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer The consumer of create the builder of notification.
     */
    public static void notify(String tag, int id, com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(int id, ChannelConfig channelConfig, com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(String tag, int id, ChannelConfig channelConfig, com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<NotificationCompat.Builder> consumer) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager nm = (NotificationManager) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.NOTIFICATION_SERVICE);
            //noinspection ConstantConditions
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationManagerCompat nmc = NotificationManagerCompat.from(com.zqy.sdk.superutils.utilcode.util.Utils.getApp());

        NotificationCompat.Builder builder = new NotificationCompat.Builder(com.zqy.sdk.superutils.utilcode.util.Utils.getApp());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(com.zqy.sdk.superutils.utilcode.util.Utils.getApp()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(com.zqy.sdk.superutils.utilcode.util.Utils.getApp()).cancel(id);
    }
    ...
    public static void cancelAll() {
        NotificationManagerCompat.from(com.zqy.sdk.superutils.utilcode.util.Utils.getApp()).cancelAll();
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService("statusbar");
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName(), Utils.getApp().getPackageName(), IMPORTANCE_DEFAULT
        );
