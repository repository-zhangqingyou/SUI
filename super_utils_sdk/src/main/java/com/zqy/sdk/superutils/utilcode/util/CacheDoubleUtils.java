...
public final class CacheDoubleUtils implements CacheConstants {
    ...
    private final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils mCacheDiskUtils;
    ...
    public static CacheDoubleUtils getInstance() {
        return getInstance(CacheMemoryUtils.getInstance(), com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils.getInstance());
    }
