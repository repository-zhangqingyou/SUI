...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration, final Object... args) {
        try {
            CharSequence text = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getResources().getText(resId);
    ...
    private static void show(final CharSequence text, final int duration) {
        UtilsBridge.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        UtilsBridge.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(com.zqy.sdk.superutils.utilcode.util.Utils.getApp());
                iToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private void setToastParams() {
            ...
            mParams.packageName = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName();
        ...
        private com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks getActivityLifecycleCallbacks() {
