...
public class NDKUtil {
    ...
    private static com.zqy.sdk.superutils.virtual.LibLoader localLibLoader = new com.zqy.sdk.superutils.virtual.LibLoader() {
        @Override
     ...
     * @param libLoader
     */
    public static void loadLibrariesOnce(com.zqy.sdk.superutils.virtual.LibLoader libLoader) {
    ...
    public NDKUtil(com.zqy.sdk.superutils.virtual.LibLoader libLoader) {
        initNDK(libLoader);
    }
