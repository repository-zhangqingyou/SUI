...
/**
 * A factory class that produces a functional {@linkcom.zqy.sutils.glide.manager.ConnectivityMonitor} if the application
 * has the {@code android.permission.ACCESS_NETWORK_STATE} permission and a no-op non functional
 * {@linkcom.zqy.sutils.glide.manager.ConnectivityMonitor} if the app does not have the required permission.
 */
