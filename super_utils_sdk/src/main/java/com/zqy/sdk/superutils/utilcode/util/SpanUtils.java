...
//            LogUtils.e(fm, sfm);
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getResources(), bitmap);
                    drawable.setBounds(
