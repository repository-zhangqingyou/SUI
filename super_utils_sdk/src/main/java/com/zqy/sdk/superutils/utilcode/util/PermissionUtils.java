...
import com.zqy.sdk.superutils.utilcode.constant.PermissionConstants;
...
import static com.zqy.sdk.superutils.utilcode.constant.PermissionConstants.Permission;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(com.zqy.sdk.superutils.utilcode.util.Utils.getApp());
    }
    ...
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        ...
        intent.setData(Uri.parse("package:" + com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName()));
        if (!com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isIntentAvailable(intent)) {
    ...
    public static boolean isGrantedDrawOverlays() {
        return Settings.canDrawOverlays(com.zqy.sdk.superutils.utilcode.util.Utils.getApp());
    }
    ...
    public static void launchAppDetailsSettings() {
        Intent intent = com.zqy.sdk.superutils.utilcode.util.UtilsBridge.getLaunchAppDetailsSettingsIntent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getPackageName(), true);
        if (!com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isIntentAvailable(intent)) return;
