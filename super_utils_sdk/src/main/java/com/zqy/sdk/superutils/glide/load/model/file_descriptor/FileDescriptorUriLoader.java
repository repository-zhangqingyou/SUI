package com.zqy.sdk.superutils.glide.load.model.file_descriptor;
...
import com.zqy.sdk.superutils.glide.load.data.FileDescriptorAssetPathFetcher;
import com.zqy.sdk.superutils.glide.load.data.FileDescriptorLocalUriFetcher;
...
import com.zqy.sdk.superutils.glide.load.model.UriLoader;
...
public class FileDescriptorUriLoader extends UriLoader<ParcelFileDescriptor> implements FileDescriptorModelLoader<Uri> {
    ...
    /**
     * The default factory for {@linkcom.zqy.sutils.glide.load.model.file_descriptor.FileDescriptorUriLoader}s.
     */
