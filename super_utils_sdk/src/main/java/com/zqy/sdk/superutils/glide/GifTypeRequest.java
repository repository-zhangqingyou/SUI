...
import com.zqy.sdk.superutils.glide.load.resource.transcode.GifDrawableBytesTranscoder;
...
import com.zqy.sdk.superutils.glide.provider.FixedLoadProvider;

import java.io.InputStream;

/**
 * A class for creating a load request that either loads an {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable}
 * directly or that adds an {@linkcom.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder} to transcode
 * {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable} into another resource type.
 *
 * @param <ModelType> The type of model to load the {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable} or other
...
public class GifTypeRequest<ModelType> extends GifRequestBuilder<ModelType> {
    ...
    /**
     * Sets a transcoder to transcode the decoded {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable} into another
     * resource type.
     *
     * @param transcoder The transcoder to use.
     * @param transcodeClass The {@link Class} of the resource the
     * {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable} will be transcoded to.
     *
     * @param <R> The type of the resource the {@linkcom.zqy.sutils.glide.load.resource.gif.GifDrawable} will be
     *           trasncoded to.
