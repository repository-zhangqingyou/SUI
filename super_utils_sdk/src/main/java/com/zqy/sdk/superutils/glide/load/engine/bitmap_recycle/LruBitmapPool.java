package com.zqy.sdk.superutils.glide.load.engine.bitmap_recycle;
...
/**
 * An {@linkcom.zqy.sutils.glide.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@linkcom.zqy.sutils.glide.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s and then uses an LRU
