...
public final class CacheDiskStaticUtils {
    ...
    private static com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils sDefaultCacheDiskUtils;

    /**
     * Set the default instance of {@link com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils}.
     *
     * @param cacheDiskUtils The default instance of {@link com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils}.
     */
    public static void setDefaultCacheDiskUtils(final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @param key            The key of cache.
     * @param value          The value of cache.
     * @param cacheDiskUtils The instance of {@link com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils}.
     */
    public static void put(@NonNull final String key,
                           final byte[] value,
                           @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the bytes if cache exists or null otherwise
     */
    public static byte[] getBytes(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the string value if cache exists or null otherwise
     */
    public static String getString(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the JSONObject if cache exists or null otherwise
     */
    public static JSONObject getJSONObject(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the JSONArray if cache exists or null otherwise
     */
    public static JSONArray getJSONArray(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Bitmap getBitmap(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the drawable if cache exists or null otherwise
     */
    public static Drawable getDrawable(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Object getSerializable(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the size of cache, in bytes
     */
    public static long getCacheSize(@NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return the count of cache
     */
    public static int getCacheCount(@NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static boolean remove(@NonNull final String key, @NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static boolean clear(@NonNull final com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils cacheDiskUtils) {
        return cacheDiskUtils.clear();
    }

    private static com.zqy.sdk.superutils.utilcode.util.CacheDiskUtils getDefaultCacheDiskUtils() {
