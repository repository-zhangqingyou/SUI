...
import com.zqy.sdk.superutils.glide.load.MultiTransformation;
...
import com.zqy.sdk.superutils.glide.load.resource.UnitTransformation;
...
import com.zqy.sdk.superutils.glide.provider.ChildLoadProvider;
import com.zqy.sdk.superutils.glide.provider.LoadProvider;
import com.zqy.sdk.superutils.glide.request.FutureTarget;
import com.zqy.sdk.superutils.glide.request.GenericRequest;
import com.zqy.sdk.superutils.glide.request.Request;
import com.zqy.sdk.superutils.glide.request.RequestCoordinator;
import com.zqy.sdk.superutils.glide.request.RequestFutureTarget;
import com.zqy.sdk.superutils.glide.request.RequestListener;
import com.zqy.sdk.superutils.glide.request.ThumbnailRequestCoordinator;
import com.zqy.sdk.superutils.glide.request.animation.GlideAnimationFactory;
import com.zqy.sdk.superutils.glide.request.animation.NoAnimation;
import com.zqy.sdk.superutils.glide.request.animation.ViewAnimationFactory;
import com.zqy.sdk.superutils.glide.request.animation.ViewPropertyAnimation;
import com.zqy.sdk.superutils.glide.request.animation.ViewPropertyAnimationFactory;
import com.zqy.sdk.superutils.glide.request.target.PreloadTarget;
import com.zqy.sdk.superutils.glide.request.target.Target;
import com.zqy.sdk.superutils.glide.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@linkcom.zqy.sutils.glide.load.model.ModelLoader} will provide that
 *                  can be decoded by the {@linkcom.zqy.sutils.glide.load.ResourceDecoder}.
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@linkcom.zqy.sutils.glide.load.model.ModelLoader}, {@linkcom.zqy.sutils.glide.load.ResourceDecoder}, and
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.ResourceDecoder} to use to load the resource from the original data.
     ...
     * @seecom.zqy.sutils.glide.load.engine.DiskCacheStrategy
     *
     * @param decoder The {@linkcom.zqy.sutils.glide.load.ResourceDecoder} to use to decode the resource.
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.ResourceDecoder} to use to load the resource from the disk cache. By
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy} to use for this load. Defaults to
     * {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#RESULT}.
     *
     * <p>
     *     For most applications {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#RESULT} is ideal.
     ...
     *     {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#SOURCE} or
     *     {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#RESULT}. Any download only operations should
     *     typically use {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#SOURCE}.
     * </p>
     *
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.Encoder} to use to encode the original data directly to cache. Will only
     * be used if the original data is not already in cache and if the
     * {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy} is set to
     * {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#SOURCE} or
     * {@linkcom.zqy.sutils.glide.load.engine.DiskCacheStrategy#ALL}.
     *
    ...
    /**
     * Removes the current {@linkcom.zqy.sutils.glide.load.Transformation}.
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@linkcom.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder} to use for this load.
     *
     * @seecom.zqy.sutils.glide.load.resource.transcode.UnitTranscoder
     * @seecom.zqy.sutils.glide.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @seecom.zqy.sutils.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     * memory cache).
     *
     * @param animator The {@linkcom.zqy.sutils.glide.request.animation.ViewPropertyAnimation.Animator} to run.
     * @return This request builder.
     */
     ...
     * </p>
     *
     * @seecom.zqy.sutils.glide.signature.StringSignature
     *
     * @param signature A unique non-null {@linkcom.zqy.sutils.glide.load.Key} representing the current state of the
     ...
     * @return The {@linkcom.zqy.sutils.glide.request.target.Target} used to wrap the given {@link ImageView}.
     */
     ...
     *
     * @return An {@linkcom.zqy.sutils.glide.request.FutureTarget} that can be used to obtain the
     ...
     *
     *
     * @seecom.zqy.sutils.glide.ListPreloader
     *
     * @param width The desired width in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     *             {@link #override * (int, int)} if previously called.
     * @param height The desired height in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
