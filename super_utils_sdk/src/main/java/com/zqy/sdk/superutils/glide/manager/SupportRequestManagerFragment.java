 ...
 * {@linkcom.zqy.sutils.glide.RequestManager} that can be used to start, stop and manage Glide requests started for
 * targets within the fragment or activity this fragment is a child of.
 *
 * @seecom.zqy.sutils.glide.manager.RequestManagerFragment
 * @seecom.zqy.sutils.glide.manager.RequestManagerRetriever
 * @seecom.zqy.sutils.glide.RequestManager
 */
public class SupportRequestManagerFragment extends Fragment {
    ...
    /**
     * Sets the current {@linkcom.zqy.sutils.glide.RequestManager}.
     *
...
//    }
    ...
    public ActivityFragmentLifecycle getLifecycle2() {
        return lifecycle;
    }

    /**
     * Returns the current {@linkcom.zqy.sutils.glide.RequestManager} or null if none is set.
     */
