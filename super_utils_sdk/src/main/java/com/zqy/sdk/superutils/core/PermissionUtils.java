...
import com.zqy.sdk.superutils.utilcode.util.UtilsTransActivity;
...
public class PermissionUtils {
    ...
    private static void permission(String[] permissions) {
        if (!com.zqy.sdk.superutils.utilcode.util.PermissionUtils.isGranted(permissions)) {
            @SuppressLint("WrongConstant")
            com.zqy.sdk.superutils.utilcode.util.PermissionUtils callback = com.zqy.sdk.superutils.utilcode.util.PermissionUtils
                    .permission(permissions)  // : 设置请求权限
                    .rationale(new com.zqy.sdk.superutils.utilcode.util.PermissionUtils.OnRationaleListener() {
                        @Override
                    ...
                    .callback(new com.zqy.sdk.superutils.utilcode.util.PermissionUtils.SimpleCallback() {
                                  @Override
                                  ...
                                  public void onDenied() {
                                      ...
                                      com.zqy.sdk.superutils.utilcode.util.PermissionUtils.launchAppDetailsSettings();
