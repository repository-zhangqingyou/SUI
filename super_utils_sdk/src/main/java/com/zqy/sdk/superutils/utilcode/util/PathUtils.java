...
public final class PathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getApplicationInfo().dataDir;
        }
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getDataDir());
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getApplicationInfo().dataDir + "/code_cache";
        }
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getCodeCacheDir());
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getCacheDir());
    }
    ...
    public static String getInternalAppDbsPath() {
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getDatabasePath(name));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getFilesDir());
    }
    ...
    public static String getInternalAppSpPath() {
        return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getApplicationInfo().dataDir + "/shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getApplicationInfo().dataDir + "/no_backup";
        }
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getNoBackupFilesDir());
    }
    ...
    public static String getExternalAppDataPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        File externalCacheDir = com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalCacheDir();
    ...
    public static String getExternalAppCachePath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalCacheDir());
    }
    ...
    public static String getExternalAppFilesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(null));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath(com.zqy.sdk.superutils.utilcode.util.Utils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
