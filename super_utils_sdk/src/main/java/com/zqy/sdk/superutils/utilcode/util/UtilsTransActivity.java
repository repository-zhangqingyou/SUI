...
public class UtilsTransActivity extends AppCompatActivity {
    ...
    public static void start(final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Intent> consumer,
    ...
    public static void start(final Activity activity,
                             final com.zqy.sdk.superutils.utilcode.util.Utils.Consumer<Intent> consumer,
                             final TransActivityDelegate delegate) {
    ...
    protected static void start(final Activity activity,
        ...
        Intent starter = new Intent(com.zqy.sdk.superutils.utilcode.util.Utils.getApp(), cls);
