...
final class UtilsActivityLifecycleImpl implements Application.ActivityLifecycleCallbacks {
    ...
    private final List<com.zqy.sdk.superutils.utilcode.util.Utils.OnAppStatusChangedListener>                mStatusListeners               = new ArrayList<>();
    private final Map<Activity, List<com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks>> mActivityLifecycleCallbacksMap = new ConcurrentHashMap<>();
    ...
    Activity getTopActivity() {
        ...
        for (Activity activity : activityList) {
            if (!com.zqy.sdk.superutils.utilcode.util.UtilsBridge.isActivityAlive(activity)) {
                continue;
            }
            return activity;
        }
    ...
    void addOnAppStatusChangedListener(final com.zqy.sdk.superutils.utilcode.util.Utils.OnAppStatusChangedListener listener) {
        mStatusListeners.add(listener);
    }

    void removeOnAppStatusChangedListener(final com.zqy.sdk.superutils.utilcode.util.Utils.OnAppStatusChangedListener listener) {
        mStatusListeners.remove(listener);
    }

    void addActivityLifecycleCallbacks(final Activity activity,
                                       final com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks listener) {
    ...
    private void addActivityLifecycleCallbacksInner(final Activity activity,
                                                    final com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks lifecycleCallbacks) {
        List<com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks> callbacks = mActivityLifecycleCallbacksMap.get(activity);
        if (callbacks == null) {
    ...
    private void consumeActivityLifecycleCallbacks(Activity activity, Lifecycle.Event event) {
        List<com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks> listeners = mActivityLifecycleCallbacksMap.get(activity);
        if (listeners != null) {
            for (com.zqy.sdk.superutils.utilcode.util.Utils.ActivityLifecycleCallbacks listener : listeners) {
    ...
    public void onActivityCreated(@NonNull Activity activity, Bundle savedInstanceState) {
        com.zqy.sdk.superutils.utilcode.util.UtilsBridge.applyLanguage(activity);
        setAnimatorsEnabled();
    ...
    public void onActivityDestroyed(@NonNull Activity activity) {
        ...
        com.zqy.sdk.superutils.utilcode.util.UtilsBridge.fixSoftInputLeaks(activity);
    ...
    private void postStatus(final Activity activity, final boolean isForeground) {
        ...
        for (com.zqy.sdk.superutils.utilcode.util.Utils.OnAppStatusChangedListener statusListener : mStatusListeners) {
            if (isForeground) {
