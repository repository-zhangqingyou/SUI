...
/**
 * A {@linkcom.zqy.sutils.glide.request.animation.GlideAnimation GlideAnimation} that accepts an interface
...
public class ViewPropertyAnimation<R> implements GlideAnimation<R> {
     ...
     * {@linkcom.zqy.sutils.glide.request.animation.ViewPropertyAnimation.Animator} interface that can apply an animation
     * to a view.
     *
    ...
    /**
     * Always applies the {@linkcom.zqy.sutils.glide.request.animation.ViewPropertyAnimation.Animator} given in the
