package com.zqy.sdk.superui.widget;
...
//    public static final int SHAPE_OVAL = 0x0010;
    ...
    private void initViews(AttributeSet attrs) {
        ...
        mRoundCornerRadius = 0;

        mShadowSide =ALL;

        mShadowShape = SHAPE_RECTANGLE;

        mCornerPosition = CORNER_ALL;
    ...
    public void setShadowSide(int mShadowSide) {
        this.mShadowSide = mShadowSide;
    }

    public void setCornerPosition(int mCornerPosition) {
        this.mCornerPosition = mCornerPosition;
    }

    public void setShadowShape(int mShadowShape) {
        this.mShadowShape = mShadowShape;
    }

    public void setRoundCornerRadius(float mRoundCornerRadius) {
        this.mRoundCornerRadius = mRoundCornerRadius;
    }
