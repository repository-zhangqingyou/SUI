package com.zqy.sdk.superui.other.drawable;
...
import com.zqy.sdk.superutils.core.StyleaUtils;
import com.zqy.sdk.superutils.utilcode.util.ColorUtils;
...
public class SuperGradientDrawable extends GradientDrawable {
    ...
    public void initTypedArray(View view, Context context, AttributeSet attrs) {
        ...
        String packageName = "com.zqy.sdk.superui";
