...
package com.zqy.sdk.superui.widget.tablayout;
...
import com.zqy.sdk.superutils.core.ResourcesUtil;
import com.zqy.sdk.superutils.utilcode.util.SizeUtils;
...
public class TabLayoutX extends HorizontalScrollView {
    ...
    public TabLayoutX(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //自己的自定义属性
        mTabLineOffset = 0;//下划线的宽度

        mTabStrip.setSelectedIndicatorHeight(0);
...
//        a.recycle();
        ...
        mTabTextMultiLineSize = SizeUtils.px2sp(12);
        mScrollableTabMinWidth = SizeUtils.dp2px(72);
    ...
    public void setTabPaddingStart(int mTabPaddingStart) {
    ...
    public void setTabPaddingEnd(int mTabPaddingEnd) {
    ...
    public void setTabTextAppearance(int mTabTextAppearance) {
        this.mTabTextAppearance = mTabTextAppearance;
    }
    ...
    public void setRequestedTabMinWidth(int mRequestedTabMinWidth) {
        this.mRequestedTabMinWidth = mRequestedTabMinWidth;
    }
    public void setRequestedTabMaxWidth(int mRequestedTabMaxWidth) {
        this.mRequestedTabMaxWidth = mRequestedTabMaxWidth;
    }


    public void setTabBackgroundResId(int mTabBackgroundResId) {
        this.mTabBackgroundResId = mTabBackgroundResId;
    }
    public void setContentInsetStart(int mContentInsetStart) {
        this.mContentInsetStart = mContentInsetStart;
    }
    /**
    ...
    private void addTabFromItemView(@NonNull TabItem item) {
        ...
        if (item.getCustomLayout() != 0) {
            tab.setCustomView(item.getCustomLayout());
        }
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext())
                            .inflate(ResourcesUtil.getLayoutId("design_layout_tab_icon"), this, false);
                    addView(iconView, 0);
                    mIconView = iconView;
                }
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(ResourcesUtil.getLayoutId("design_layout_tab_text") , this, false);
                    addView(textView);
                    mTextView = textView;
