 ...
 */
package com.zqy.sdk.superhttp.okio;

import java.io.IOException;
import java.util.concurrent.TimeUnit;

/** A {@link okio.Timeout} which forwards calls to another. Useful for subclassing. */
public class ForwardingTimeout extends Timeout {
  ...
  /** {@link okio.Timeout} instance to which this instance is currently delegating. */
