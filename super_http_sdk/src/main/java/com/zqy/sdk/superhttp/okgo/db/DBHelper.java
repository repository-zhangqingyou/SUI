 ...
 */
package com.zqy.sdk.superhttp.okgo.db;
...
import com.zqy.sdk.superhttp.okgo.cookie.SerializableCookie;
...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (com.zqy.sdk.superhttp.okgo.db.DBUtils.isNeedUpgradeTable(db, cacheTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_CACHE);
        if (com.zqy.sdk.superhttp.okgo.db.DBUtils.isNeedUpgradeTable(db, cookieTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_COOKIE);
        if (com.zqy.sdk.superhttp.okgo.db.DBUtils.isNeedUpgradeTable(db, downloadTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_DOWNLOAD);
