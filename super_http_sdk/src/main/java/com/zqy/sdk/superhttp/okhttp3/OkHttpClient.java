 ...
 */
package com.zqy.sdk.superhttp.okhttp3;

import com.zqy.sdk.superhttp.okhttp3.internal.Internal;
import com.zqy.sdk.superhttp.okhttp3.internal.Util;
import com.zqy.sdk.superhttp.okhttp3.internal.cache.InternalCache;
import com.zqy.sdk.superhttp.okhttp3.internal.connection.RealConnection;
import com.zqy.sdk.superhttp.okhttp3.internal.connection.RouteDatabase;
...
import com.zqy.sdk.superhttp.okhttp3.internal.tls.CertificateChainCleaner;
...
/**
 * Factory for {@linkplain //okhttp3.Call calls}, which can be used to send HTTP requests and read their
 * responses.
 *
 ...
 * }</pre>
 *
 * <p>If your client has a cache, call {@link //okhttp3.Cache#close close()}. Note that it is an error to
...
public class OkHttpClient implements Cloneable,Call.Factory,WebSocket.Factory {
 ...
 Cache cache;
   ...
   * These interceptors must call {@linkInterceptor.Chain#proceed} exactly once: it is an error for
  ...
  public static final class Builder {
   ...
   Dns dns;
     ...
     *
     * <p>If unset, {@linkplainCookieJar#NO_COOKIES no cookies} will be accepted nor provided.
     */
     ...
     *
     * <p>If unset, the {@linkDns#SYSTEM system-wide default} DNS will be used.
     */
     ...
     *
     * <p>{@linkProtocol#HTTP_1_0} is not supported in this set. Requests are initiated with {@code
     * HTTP/1.1} only. If the server responds with {@code HTTP/1.0}, that will be exposed by {@link
     * Response#protocol()}.
     *
     * @param protocols the protocols to use, in order of preference. The list must contain {@link
     *Protocol#HTTP_1_1}. It must not contain null or {@linkProtocol#HTTP_1_0}.
     */
     ...
     * These interceptors must call {@linkInterceptor.Chain#proceed} exactly once: it is an error
