...
public abstract class StringDataCallBack implements DataCallBack<String> {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                if (SuperHttpManage.getHttpApiCallback() != null) {
                    SuperHttpManage.getHttpApiCallback().onStart(baseUrl, endUrl, headers, requestParameters);
                }
    ...
    public void onError(final String erro) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                if (SuperHttpManage.getHttpApiCallback() != null) {
                    SuperHttpManage.getHttpApiCallback().onError(baseUrl, endUrl, erro);
                }
    ...
    public void onSuccess(final String response) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                if (SuperHttpManage.getHttpApiCallback() != null) {
                    SuperHttpManage.getHttpApiCallback().onSuccess(baseUrl, endUrl, response);
                }
    ...
    public void onFinish(final String msg) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                if (SuperHttpManage.getHttpApiCallback() != null) {
                    SuperHttpManage.getHttpApiCallback().onFinish(msg);
                }
