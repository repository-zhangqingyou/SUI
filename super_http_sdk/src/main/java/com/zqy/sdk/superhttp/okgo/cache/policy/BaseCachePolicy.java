 ...
 */
package com.zqy.sdk.superhttp.okgo.cache.policy;
...
import com.zqy.sdk.superhttp.okgo.db.CacheManager;
import com.zqy.sdk.superhttp.okgo.exception.HttpException;
import com.zqy.sdk.superhttp.okgo.model.Response;
import com.zqy.sdk.superhttp.okgo.request.base.Request;
import com.zqy.sdk.superhttp.okgo.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    @Override
    public boolean onAnalysisResponse(Call call, com.zqy.sdk.superhttp.okhttp3.Response response) {
        return false;
    }
    ...
    protected Response<T> requestNetworkSync() {
        try {
            com.zqy.sdk.superhttp.okhttp3.Response response = rawCall.execute();
    ...
    protected void requestNetworkAsync() {
        rawCall.enqueue(new com.zqy.sdk.superhttp.okhttp3.Callback() {
            @Override
            ...
            @Override
            public void onResponse(Call call, com.zqy.sdk.superhttp.okhttp3.Response response) throws IOException {
                int responseCode = response.code();
