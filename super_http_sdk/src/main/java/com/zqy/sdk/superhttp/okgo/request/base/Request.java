 ...
 */
package com.zqy.sdk.superhttp.okgo.request.base;

import android.text.TextUtils;

import com.zqy.sdk.superhttp.okgo.OkGo;
import com.zqy.sdk.superhttp.okgo.adapter.AdapterParam;
import com.zqy.sdk.superhttp.okgo.adapter.CacheCall;
import com.zqy.sdk.superhttp.okgo.adapter.Call;
import com.zqy.sdk.superhttp.okgo.adapter.CallAdapter;
import com.zqy.sdk.superhttp.okgo.cache.CacheEntity;
import com.zqy.sdk.superhttp.okgo.cache.CacheMode;
import com.zqy.sdk.superhttp.okgo.cache.policy.CachePolicy;
import com.zqy.sdk.superhttp.okgo.callback.Callback;
import com.zqy.sdk.superhttp.okgo.convert.Converter;
import com.zqy.sdk.superhttp.okgo.model.HttpHeaders;
import com.zqy.sdk.superhttp.okgo.model.HttpMethod;
import com.zqy.sdk.superhttp.okgo.model.HttpParams;
import com.zqy.sdk.superhttp.okgo.utils.HttpUtils;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    protected transient com.zqy.sdk.superhttp.okhttp3.Request mRequest;
    ...
    public com.zqy.sdk.superhttp.okhttp3.Request getRequest() {
        return mRequest;
    }
    ...
    public abstract com.zqy.sdk.superhttp.okhttp3.Request generateRequest(RequestBody requestBody);

    /** 获取okhttp的同步call对象 */
    public com.zqy.sdk.superhttp.okhttp3.Call getRawCall() {
        //构建请求体，返回call对象
