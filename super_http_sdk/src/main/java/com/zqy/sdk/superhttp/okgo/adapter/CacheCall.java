 ...
 */
package com.zqy.sdk.superhttp.okgo.adapter;

import com.zqy.sdk.superhttp.okgo.cache.CacheEntity;
import com.zqy.sdk.superhttp.okgo.cache.policy.CachePolicy;
import com.zqy.sdk.superhttp.okgo.cache.policy.DefaultCachePolicy;
import com.zqy.sdk.superhttp.okgo.cache.policy.FirstCacheRequestPolicy;
import com.zqy.sdk.superhttp.okgo.cache.policy.NoCachePolicy;
import com.zqy.sdk.superhttp.okgo.cache.policy.NoneCacheRequestPolicy;
import com.zqy.sdk.superhttp.okgo.cache.policy.RequestFailedCachePolicy;
 ...
 * ================================================
 */
public class CacheCall<T> implements com.zqy.sdk.superhttp.okgo.adapter.Call<T> {
