...
import com.zqy.sdk.superhttp.okgo.exception.CacheException;
...
public class DefaultCachePolicy<T> extends BaseCachePolicy<T> {
    ...
    @Override
    public boolean onAnalysisResponse(final Call call, final com.zqy.sdk.superhttp.okhttp3.Response response) {
