...
public interface Connection {
  ...
  /**
   * Returns the protocol negotiated by this connection, or {@link okhttp3.Protocol#HTTP_1_1} if no protocol
   * has been negotiated. This method returns {@link okhttp3.Protocol#HTTP_1_1} even if the remote peer is
   * using {@link okhttp3.Protocol#HTTP_1_0}.
   */
  Protocol protocol();
}
