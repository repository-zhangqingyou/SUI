...
public abstract class BodyRequest<T, R extends BodyRequest> extends Request<T, R> implements HasBody<R> {
    ...
    protected com.zqy.sdk.superhttp.okhttp3.Request.Builder generateRequestBuilder(RequestBody requestBody) {
        try {
            headers(HttpHeaders.HEAD_KEY_CONTENT_LENGTH, String.valueOf(requestBody.contentLength()));
        } catch (IOException e) {
            OkLogger.printStackTrace(e);
        }
        com.zqy.sdk.superhttp.okhttp3.Request.Builder requestBuilder = new com.zqy.sdk.superhttp.okhttp3.Request.Builder();
